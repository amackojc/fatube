...
Welcome to ``FATube`` contributor's guide.
...
If you experience bugs or general issues with ``FATube``, please have a look
...
You can help improve ``FATube`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``FATube`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``FATube``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n FATube python=3 six virtualenv pytest pytest-cov
    conda activate FATube
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/FATube.git
    cd FATube
...
#. Install |pre-commit|_::
   ...
   ``FATube`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/FATube
.. _issue tracker: https://github.com/<USERNAME>/FATube/issues
.. <-- end -->
